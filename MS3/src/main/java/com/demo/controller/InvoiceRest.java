...
public class InvoiceRest {
    ...
    public ResponseEntity<Invoice> updateInvoice(@PathVariable("id") Long id,@RequestBody Invoice invoice){
        ...
        invoice.setId(id);
        Invoice currentInvoice = invoiceService.updatedInvoice(invoice);
        if(currentInvoice == null){
            log.error("Unable to Update. Invoice with id {} not foubd",id);
            return ResponseEntity.notFound().build();
        }
    ...
    public ResponseEntity<Invoice> deleteInvoice(@PathVariable("id") Long id){i
        ...
        invoice = invoiceService.deletedInvoice(invoice);
